  ...
  },
  {
    ...
    answer: (
      <div className="faq-answer">
        <p>Возврат можно оформить в течение 14 дней после получения заказа, если товар не был в употреблении и сохранены его товарный вид, потребительские свойства, комплектность и фабричные ярлыки.</p>
        <p>Чтобы оформить возврат, откройте:</p>
        <p className="faq-answer__path">«Корзина» → «Заказы» → «Подробнее» у нужного заказа → меню ⋮ в правом верхнем углу → «Оформить возврат».</p>
        ...
        <p>Возврат доступен только для доставленных заказов и товаров, разрешённых к возврату. Статус заявки можно посмотреть в информации о заказе. Стоимость доставки не возвращается.</p>
      </div>
    ),
  },
];
