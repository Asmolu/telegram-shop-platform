...
Alembic revision `20260711_0053`, with claim fencing added by `20260712_0054`. Business state
and immutable event snapshots commit together; an in-process lifespan worker performs independent
seller/customer delivery with bounded retry, fenced stale-lock recovery, lease heartbeat renewal,
and authorized diagnostics. Semantics are at-least-once. Database consumer
